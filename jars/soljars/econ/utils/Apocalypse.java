...
public class Apocalypse {
    ...
    public static void execute(final MarketAPI market, String conditionToRemove) {
        ...
        final String text = "An antimatter containment cell detonates on " + marketName + ", within minutes billions are killed in the ensuing failure of systems, communication channels, and judgement.";
