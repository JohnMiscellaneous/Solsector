...
import soljars.econ.utils.Apocalypse;

public class AntimatterNonproliferationTreatySignatory extends BaseHazardCondition implements EconomyTickListener {
    ...
    public void reportEconomyTick(int iterIndex) {
        ...
        // Outcome B: Minimal Compliance (Failure -> Arms Race)
            ...
            if (elapsed >= 150f) { // ~20 Ticks
                ...
                RemoveReplace.execute(market, ID, "sol_antimatter_nonproliferation_treaty_breacher");
