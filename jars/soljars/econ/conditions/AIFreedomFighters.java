...
public class AIFreedomFighters extends BaseHazardCondition {
    ...
    protected void createTooltipAfterDescription(TooltipMakerAPI tooltip, boolean expanded) {
        ...
        int size = market.getSize();
        boolean hasDefense = IndustryCompat.getDefense(market) != null;
        boolean surgeActive = market.getMemoryWithoutUpdate().getBoolean(KEY_SURGE_ACTIVE);
        ...
        public void advance(float amount) {
            ...
            if (market.getMemoryWithoutUpdate().contains(KEY_DAYS_LEFT)) {
                ...
                if (daysLeft <= 0) {
                    ...
                    // Intel: surge ended
                    IntelHelper.SolChainIntel chain = IntelHelper.getChain("ai_surge_" + market.getId());
                    if (chain != null) {
                    ...
                    RemoveReplace.execute(market, "sol_ai_freedom_fighters", null);
