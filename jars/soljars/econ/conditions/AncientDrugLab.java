...
public class AncientDrugLab extends BaseHazardCondition implements MarketImmigrationModifier {
    ...
    public void apply(String id) {
        ...
        Industry lightInd = IndustryCompat.getLightIndustry(market);
        boolean hasLightInd = (lightInd != null);
        
        boolean hasPatrolHQ = IndustryCompat.getMilitary(market) != null;
