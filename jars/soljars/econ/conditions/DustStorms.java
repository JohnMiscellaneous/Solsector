...
public class DustStorms extends BaseHazardCondition {
        ...
        public void advance(float amount) {
            ...
            if (daysRemaining <= 0) {
                ...
                if ("habitable".equals(triggerCondition)) {
                    ...
                    // atmosphere loss 
                    IntelHelper.create("Dust Storms Ended", "graphics/icons/markets/dust_storm.png")
                        .market(market)
                        .subtitle("Dust storms ended on " + marketName)
                ...
                RemoveReplace.execute(market, CONDITION_ID, null);
                cleanup();
            }
        }
