...
public class AITerminators extends BaseHazardCondition {
        ...
        public void advance(float amount) {
            ...
            if (market.getMemoryWithoutUpdate().contains(KEY_DAYS_LEFT)) {
                ...
                if (daysLeft <= 0) {
                    ...
                    IntelHelper.SolChainIntel chain = IntelHelper.getChain("hk_campaign_" + market.getId());
                    if (chain != null) {
                    ...
                    RemoveReplace.execute(market, "sol_ai_terminators", null);
