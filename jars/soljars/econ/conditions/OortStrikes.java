...
public class OortStrikes extends BaseHazardCondition implements EconomyTickListener, ColonySizeChangeListener {
    ...
    protected void runTickLogic() {
        ...
        float margin = getMargin();
        boolean hasPatrols = IndustryCompat.getMilitary(market) != null;
