...
public class MegaforgesHyperenergetic extends BaseHazardCondition {
            ...
            if (market.getMemoryWithoutUpdate().contains(KEY_DAYS_LEFT)) {
                ...
                if (daysLeft <= 0) {
                    ...
                    if (nextStage == 2 && chain != null) {
                        ...
                        RemoveReplace.execute(market, "sol_megaforges_hyperenergetic", "sol_megaforges_hyperenergetic_complete");
