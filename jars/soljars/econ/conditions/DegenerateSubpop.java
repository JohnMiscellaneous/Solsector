...
public class DegenerateSubpop extends BaseMarketConditionPlugin implements MarketImmigrationModifier {
    ...
    public void apply(String id) {
        ...
        if (market.isPlanetConditionMarketOnly() || market.getSize() < 3) {
            ...
            if (!market.getMemoryWithoutUpdate().getBoolean(MEM_KEY_SWAP_QUEUED)) {
                ...
                RemoveReplace.execute(market, "sol_degenerate_subpop", "sol_degenerate");
            }
            return;
        }
    ...
    public void modifyIncoming(MarketAPI market, PopulationComposition incoming) {
        ...
        Industry defenseInd = IndustryCompat.getDefense(market);
