...
public class InsurgentNetwork extends BaseHazardCondition {
    ...
    public void apply(String id) {
        ...
        // --- Production Logic ---
        Industry heavyInd = IndustryCompat.getHeavyIndustry(market);
    ...
    public void unapply(String id) {
        ...
        cleanupIndustry(IndustryCompat.getHeavyIndustry(market), id);
    }
        ...
        public void advance(float amount) {
            ...
            if (daysLeft <= 0) {
                ...
                if (nextStage == 2 && chain != null) {
                    ...
                    RemoveReplace.execute(market, "sol_insurgent_network", "sol_insurgent_network_mapped");
