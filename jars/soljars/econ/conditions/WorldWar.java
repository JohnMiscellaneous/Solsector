...
public class WorldWar extends BaseHazardCondition implements EconomyTickListener {
    ...
    public void reportEconomyTick(int iterIndex) {
                ...
                if (state == STATE_PROLIFERATION) {
                    ...
                    if (market.isPlayerOwned()) {
                        ...
                        if (market.isPlanetConditionMarketOnly()) {
                            ...
                            RemoveReplace.execute(market, ID, "sol_antimatter_nonproliferation_treaty_signatory");
                            Global.getSector().getListenerManager().removeListener(this);
                            return;
                        }

                        Industry fuelInd = IndustryCompat.getFuelProduction(market);
                        ...
                        RemoveReplace.execute(market, ID, nextCond);
                        Global.getSector().getListenerManager().removeListener(this);
                    }
                    return;
                }
        ...
        if (state != STATE_CEASEFIRE && Math.random() < 0.25f) {
            Industry heavy = IndustryCompat.getHeavyIndustry(market);
    ...
    if (state != STATE_CEASEFIRE) {
        ...
        if (IndustryCompat.getFuelProduction(market) != null) {
    ...
    public static class CounterProliferationDialog implements InteractionDialogPlugin {
        ...
        public void optionSelected(String optionText, Object optionData) {
            ...
            if ("sign".equals(option)) {
                ...
                RemoveReplace.execute(market, currentConditionId, "sol_antimatter_nonproliferation_treaty_breacher");
                sendTreatyResultIntel(market, false, -1);
                finalizeDialog();
        ...
        private void finalizeWithTier(int tier) {
            ...
            RemoveReplace.execute(market, currentConditionId, "sol_antimatter_nonproliferation_treaty_signatory");
