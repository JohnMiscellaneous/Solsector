...
public class PondScum extends BaseHazardCondition {
    ...
    public void apply(String id) {
        ...
        if (planet != null && typeId != null && !"water".equals(typeId)) {
            ...
            IntelHelper.create("Biosphere Reshaped", "graphics/icons/markets/sol_pond_scum.png")
                .market(market)
            ...
            RemoveReplace.execute(market, "sol_pond_scum", null);
            cleanupMemory();
            return;
        }
        ...
        if (market.getMemoryWithoutUpdate().contains(KEY_SEEDING_START)) {
            ...
            if (currentStage != lastStage) {
                String marketName = market.getName();
                IntelHelper.SolChainIntel chain = IntelHelper.getChain(getChainId(market.getId()));
            ...
            Industry aquaculture = IndustryCompat.getAquaculture(market);
            if (aquaculture != null) {
