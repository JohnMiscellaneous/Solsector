...
public class DistErebal extends BaseHazardCondition {
    ...
    protected void createTooltipAfterDescription(TooltipMakerAPI tooltip, boolean expanded) {
        ...
        if (!isColonized) {
            ...
            if (hasMilitary && hasWaystation) {
                ...
                tooltip.addPara("Conditions on %s are devastated by a lack of a %s.",
                    pad, Misc.getHighlightColor(), market.getName(), "Waystation");
            } else if (!hasMilitary && hasWaystation) {
                tooltip.addPara("Conditions on %s are devastated by a lack of a %s.",
                    pad, Misc.getHighlightColor(), market.getName(), "Patrol HQ");
            } else {
                tooltip.addPara("Conditions on %s are devastated by a lack of a %s and a %s.",
